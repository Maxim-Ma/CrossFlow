...
class MFDiT(nn.Module):
    ...
    def __init__(
        ...
        self.r_embedder = TimestepEmbedder(hidden_size) # add
    ...
    def initialize_weights(self):
        ...
        # TODO: r_embedder may need initilization
    ...
    def _forward(self, x, t, r, null_indicator):
        """
        Forward pass of DiT.
        ...
        r = self.r_embedder(r)                   # (N, D) , added
        y = self.y_embedder(null_indicator)    # (N, D)
        c = t + r + y                                # (N, D), modified
        for block in self.blocks:
            x = block(x, c)                      # (N, T, D)
    ...
    def _forward_with_cfg(self, x, t, r, cfg_scale):
        """
        ...
        model_out = self.forward(combined, t, r)
    ...
    def forward(self, x, t = None, r = None, text_encoder=False, text_decoder=False, image_clip=False, shape=None, mask=None, null_indicator=None):
        if text_encoder:
            ...
            return self._forward(x = x, t = t, r = r, null_indicator=null_indicator)
